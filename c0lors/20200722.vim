...
let g:colors_name = "22072020"

let @r = ':w:C 22072020'
let @f = ':aguifg=#'

hi normal           guifg=#af6666       guibg=#ffffff       cterm=bold
hi nontext          guifg=magenta
hi comment          guifg=#aaddaa       cterm=bold
hi constant         guifg=#666666
hi identifier       guifg=#bb5599
hi statement        guifg=#a5a080
hi preproc          guifg=#000000       cterm=bold
...
hi directory         guifg=#46004b      cterm=bold
